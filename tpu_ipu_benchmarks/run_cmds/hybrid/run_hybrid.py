...
def main():
    ...
    # IPU Imports
    if args.device == 'ipu':
        from models.hybrid.hybrid_ipu import Hybrid_IPU
        import poptorch
        print('Using IPU...')
    elif args.device == 'ipu_manual':
        from models.hybrid.hybrid_ipu_manual import Hybrid_IPU_MANUAL_BAG
        import poptorch
    ...
    # Default: CPU, GPU
        ...
        from models.hybrid.hybrid import Hybrid
        if args.device == 'cpu':
            device = 'cpu'
            print('Using CPU...')
    ...
    if args.inference == True:
        if args.device == 'cpu' or args.device == 'gpu':
            ...
            print('Total Inference Time (Stable): {:.3f} ms/it'.format(np.median(timing_vector_tpu)*len(timing_vector_tpu)))
