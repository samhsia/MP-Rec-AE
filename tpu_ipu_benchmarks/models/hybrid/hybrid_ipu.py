...
class Hybrid_IPU(nn.Module):
    ...
    def create_embedding_tables(
        ...
        for size in table_sizes:
            table = nn.EmbeddingBag(size, emb_dim, mode='sum')
    ...
    def __init__(
        ...
        super(Hybrid_IPU, self).__init__()
    ...
    def forward(self, x_dense, x_indices, labels=None):
        ...
        embeddings_tbl = self.apply_embedding_tables(self.constant_offsets, x_indices, self.embedding_tables)
