...
from models.xla_embedding_bag import XlaEmbeddingBag

class Hybrid_TPU(nn.Module):
    ...
    def create_embedding_tables(
        ...
        for size in table_sizes:
            table = XlaEmbeddingBag(size, emb_dim, mode='sum', sparse=False, offset=num_lookups)
    ...
    def __init__(
        ...
        super(Hybrid_TPU, self).__init__()
        ...
        self.embedding_tables, self.tables_size = self.create_embedding_tables(self.emb_dim, table_sizes, self.num_lookups, self.precision)
